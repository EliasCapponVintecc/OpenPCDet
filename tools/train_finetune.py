...
def parse_config():
    ...
    # hardcode the config file
    # args.cfg_file = "cfgs/custom_models/pointrcnn.yaml"
    # args.pretrained_model = (
    #     "/home/vintecc/Vision.Mono/projects/Vision.PointCloudAI/submodules/OpenPcdet/tools/checkpoints/second_7862.pth"
    # )
    # args.batch_size = 4
    # args.epochs = 20
...
def main():
    ...
    for name, param in model.named_parameters():
        ...
        if name.startswith("backbone_3d."):
            ...
            param.requires_grad = True  # Ensure heads are trainable

    print(f"Froze {num_params_frozen} parameters in backbone_3d.")
    print(f"Total parameters: {num_params_total}")
    print(f"Trainable parameters: {num_params_total - num_params_frozen}")
    print("=======================================================")
